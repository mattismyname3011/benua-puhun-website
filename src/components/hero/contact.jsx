const Contact = () => {
  return (
    <>
      <div className="bg-gray-900 w-4/6 mx-auto py-1 bg-opacity-90">
        <h2 class="mb-12 text-3xl font-bold text-center text-white italic">
          Contact us
        </h2>
          ...
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
              ...
              <input
                ...
                id="email"
                type="email"
                placeholder="abcd.efgh@gmail.com"
              />
